...
local newMatrix = require(blazeinc.path .. "/matrices")
local loadObjFile = require(blazeinc.path .. "/objloader")
local collisions = require(blazeinc.path .. "/collisions")
local vectors = require(blazeinc.path .. "/vectors")
local camera = require(blazeinc.path .. "/camera")
...
function model:compress()
    print("[blazeinc warning] Compression requires FFI!\n" .. debug.traceback())
end
